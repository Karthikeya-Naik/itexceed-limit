      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <p className="text-xs sm:text-sm font-semibold text-orange-500 mb-2 sm:mb-3 tracking-wider uppercase">
              WORK AND JOY
            </p>
          ...
          <div className="relative order-1 lg:order-2">
            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-4">
              {/* Top Row */}
              <div className="aspect-[4/3] bg-gray-800/50 border border-gray-700 rounded-xl lg:rounded-2xl overflow-hidden group">
                <img
              ...
              <div className="aspect-[4/3] bg-gray-800/50 border border-gray-700 rounded-xl lg:rounded-2xl overflow-hidden mt-4 sm:mt-8 lg:mt-12 group">
                <img
            ...
            {/* Orange overlay effect on hover */}
            <div className="absolute inset-0 rounded-2xl lg:rounded-3xl border border-transparent group-hover:border-orange-500/30 pointer-events-none transition-all duration-300 hidden sm:block"></div>
          </div>
        </div>
      </div>
    </section>
