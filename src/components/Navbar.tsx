...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <div className="relative">
              <div className="text-2xl font-display font-bold text-white">
                IT<span className="text-orange-500">Exceed</span>
              </div>
          ...
          <div className="hidden lg:flex items-center space-x-1">
            <Link
              to="/"
              className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-orange-500 transition-colors"
            >
              Home
            </Link>
            ...
            <div className="relative group">
              <button
                className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-orange-500 transition-colors flex items-center"
                onMouseEnter={() => setServicesOpen(true)}
                onMouseLeave={() => setServicesOpen(false)}
              >
                Services
              ...
              {servicesOpen && (
                <div
                  className="absolute top-full left-0 mt-1 w-64 bg-gray-800/95 backdrop-blur-md border border-gray-700 rounded-lg shadow-xl overflow-hidden z-50"
                  onMouseEnter={() => setServicesOpen(true)}
                  onMouseLeave={() => setServicesOpen(false)}
                >
                  <div className="p-2">
                    {services.map((service, index) => {
                      ...
                      return (
                        <Link
                          ...
                          to={service.path}
                          onClick={() => setServicesOpen(false)} 
                          className={`flex items-center gap-3 px-3 py-2.5 rounded-md hover:bg-gray-700/50 transition-all group ${
                            index !== services.length - 1 ? 'mb-1' : ''
                          }`}
                        >
                          <div className="w-9 h-9 rounded-md bg-gradient-to-br from-orange-500/10 to-orange-600/5 flex items-center justify-center flex-shrink-0">
                            <IconComponent className="w-4 h-4 text-orange-400" />
                          </div>
                          <div className="flex-1">
                            <h4 className="text-sm font-medium text-white transition-colors">
                              {service.name}
                            </h4>
                          </div>
                        </Link>
                  ...
                  <div className="border-t border-gray-700 bg-gray-800/80">
                    <Link
                      to="/services"
                      onClick={() => setServicesOpen(false)}
                      className="flex items-center justify-between px-4 py-2.5 text-sm font-medium text-orange-500 hover:bg-gray-700/50 transition-colors group"
                    >
                      View More
                      <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </Link>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden bg-gradient-to-b from-gray-900 to-black border-t border-gray-800 shadow-lg">
          <div className="px-4 py-4 space-y-1 max-h-[calc(100vh-80px)] overflow-y-auto">
            <Link
              to="/"
              className="block py-2.5 px-3 text-sm font-medium text-white hover:text-orange-500 hover:bg-gray-800/50 rounded-md transition-colors"
              onClick={() => setMobileMenuOpen(false)}
            >
              Home
            </Link>
            ...
            <div className="py-2">
                ...
                {services.map((service) => {
                  ...
                  return (
                    <Link
                      key={service.name}
                      to={service.path}
                      className="flex items-center gap-3 py-2.5 px-3 rounded-md hover:bg-gray-800/50 transition-all group"
                      onClick={() => setMobileMenuOpen(false)}
                    >
                      <div className="w-8 h-8 rounded-md bg-gradient-to-br from-orange-500/10 to-orange-600/5 flex items-center justify-center flex-shrink-0">
                        <IconComponent className="w-4 h-4 text-orange-400" />
                      </div>
              ...
              <Link
                to="/services"
                className="flex items-center justify-between mt-2 py-2 px-3 text-sm font-medium text-orange-500 hover:bg-gray-800/50 rounded-md transition-colors group"
                onClick={() => setMobileMenuOpen(false)}
              >
                View All Services
                <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
