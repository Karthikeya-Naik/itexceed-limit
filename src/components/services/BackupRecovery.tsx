      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden mt-12">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-white font-semibold">Backup & Disaster Recovery</span>
          </div>
              ...
              return (
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all">
                  ...
                  <div className="inline-flex items-center gap-2 bg-emerald-100 px-3 py-1 rounded-full">
                    ...
                    <span className="text-sm font-semibold text-emerald-700">{type.frequency}</span>
                  </div>
                </div>
              );
            })}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {recoveryLevels.map((level, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border-2 border-white/10 hover:border-emerald-500 transition-all">
                <div className={`inline-block px-4 py-2 rounded-full bg-${level.color}-500/20 text-${level.color}-300 font-bold text-sm mb-4`}>
                  {level.tier}
                </div>
                <div className="mb-6">
                  <div className="text-sm text-gray-400 mb-1">Recovery Time</div>
                  <div className="text-2xl font-bold text-white mb-3">{level.rto}</div>
                  <div className="text-sm text-gray-400 mb-1">Recovery Point</div>
                  <div className="text-2xl font-bold text-white">{level.rpo}</div>
                </div>
          ...
          <div className="grid md:grid-cols-5 gap-6">
            {[
              ...
              <div key={index} className="text-center relative">
                <div className="bg-gradient-to-br from-emerald-600 to-teal-600 text-white w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 shadow-lg">
                  {item.step}
                </div>
                <h3 className="text-lg font-semibold mb-2 text-gray-900">{item.title}</h3>
                <p className="text-sm text-gray-600">{item.desc}</p>
                {index < 4 && (
                  <div className="hidden md:block absolute top-8 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-emerald-600 to-teal-600"></div>
                )}
              </div>
            ))}
          </div>
