      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden mt-12">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-white font-semibold">Wireless Solutions</span>
          </div>
                ...
                <div key={index} className="group">
                  <div className="relative h-48 overflow-hidden rounded-xl mb-4">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <IconComponent className="w-10 h-10 text-indigo-500" />
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border-2 border-white/10 hover:border-indigo-500 transition-all">
