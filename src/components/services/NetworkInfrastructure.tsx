      ...
      <section className="relative h-[500px] flex items-center justify-center overflow-hidden mt-12">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
            ...
            <span className="text-white font-semibold">Network Infrastructure Services</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {networkTypes.map((type, index) => (
              <div key={index} className="bg-white p-8 rounded-xl shadow-lg border-2 border-gray-200 hover:border-emerald-500 transition-all">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {networkComponents.map((component, index) => {
              ...
              return (
                <div key={index} className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all">
