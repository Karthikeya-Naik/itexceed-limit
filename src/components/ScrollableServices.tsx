...
const ScrollableServices = () => {
  ...
  return (
    <section className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/30 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 md:mb-12">
          <p className="text-xs md:text-sm font-semibold text-orange-400 mb-2 tracking-wider uppercase">
            MAXIMIZE EFFECTIVENESS
          </p>
        ...
        <div className="relative">
          ...
          <button
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gray-800 hover:bg-orange-500/20 rounded-full flex items-center justify-center shadow-lg transition-all -ml-2 sm:-ml-4 md:-ml-6 border border-orange-500/30 hover:border-orange-500"
            aria-label="Scroll left"
          >
            <ChevronLeft className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-orange-400" />
          </button>

          <button
            onClick={() => scroll('right')}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gray-800 hover:bg-orange-500/20 rounded-full flex items-center justify-center shadow-lg transition-all -mr-2 sm:-mr-4 md:-mr-6 border border-orange-500/30 hover:border-orange-500"
            aria-label="Scroll right"
          >
            <ChevronRight className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-orange-400" />
          </button>
            ...
            {services.map((service, index) => {
              ...
              return (
                <a
                  ...
                  className="flex-none w-[280px] sm:w-[300px] md:w-[340px] lg:w-[380px] snap-start group cursor-pointer"
                >
                  <div className="h-full bg-gray-800/50 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-lg hover:shadow-xl md:hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-700 group-hover:-translate-y-1 md:group-hover:-translate-y-2 group-hover:border-orange-500">
                    {/* Icon Header - Compact on Mobile */}
                    <div className="p-4 md:p-6 lg:p-8 border-b border-gray-700 group-hover:border-orange-500/50 transition-colors">
                      <div className="w-12 h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-br from-orange-500/10 to-orange-600/5 rounded-lg md:rounded-xl flex items-center justify-center mb-3 md:mb-4 group-hover:bg-gradient-to-br group-hover:from-orange-500/20 group-hover:to-orange-600/10 transition-all duration-300">
                        <IconComponent className="w-5 h-5 md:w-6 md:h-6 lg:w-8 lg:h-8 text-orange-400" />
                      </div>
                    ...
                    <div className="px-4 md:px-6 lg:px-8 py-3 md:py-4">
                      {service.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="mb-3 md:mb-4 last:mb-0">
                          <h4 className="text-sm md:text-base font-semibold text-white mb-1 flex items-center gap-2">
                            <span className="w-1.5 h-1.5 bg-orange-400 rounded-full flex-shrink-0"></span>
                            {item.title}
                          </h4>
                          <p className="text-xs md:text-sm text-gray-300 leading-relaxed ml-3.5">
                            {item.description}
                          </p>
                        </div>
                      ))}
                      ...
                      {/* Learn More Link */}
                      <div className="pt-2 md:pt-3 pb-4 md:pb-6 border-t border-gray-700 group-hover:border-orange-500/30 transition-colors mt-2">
                        <span className="inline-flex items-center gap-1 md:gap-2 text-xs md:text-sm font-semibold text-orange-400 group-hover:text-orange-300 group-hover:gap-2 md:group-hover:gap-3 transition-all">
                          Learn More
                          <ArrowRight className="w-3 h-3 md:w-4 md:h-4 group-hover:translate-x-1 transition-transform" />
                        </span>
                      </div>
