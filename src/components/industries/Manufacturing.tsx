...
const ManufacturingIndustry = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-700 to-gray-900 text-white mt-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="max-w-3xl">
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold">Manufacturing Technology Solutions</h1>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Industrial IT for the Future of Manufacturing</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-100 p-6 rounded-lg">
                  <div className="text-3xl font-bold text-gray-700 mb-2">99.95%</div>
                  <div className="text-sm text-gray-600">System Uptime</div>
                </div>
                <div className="bg-gray-100 p-6 rounded-lg">
                  <div className="text-3xl font-bold text-gray-700 mb-2">Zero</div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Comprehensive Manufacturing IT Solutions</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                <div className="bg-gray-200 w-14 h-14 rounded-lg flex items-center justify-center mb-6">
                  <solution.icon className="w-7 h-7 text-gray-700" />
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Benefits of Manufacturing IT</h2>
              <p className="text-lg text-gray-600 mb-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Real results for manufacturing companies</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Modernize Your Manufacturing IT?</h2>
