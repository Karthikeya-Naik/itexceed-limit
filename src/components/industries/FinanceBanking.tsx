...
const FinanceBankingIndustry = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-emerald-600 to-teal-700 text-white mt-4">
  ...
  Back to Industries
          ...
          <div className="max-w-3xl">
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold">Finance & Banking Solutions</h1>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-2xl p-12 text-white">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 mt-8">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
                  <div className="text-2xl font-bold mb-2">PCI DSS</div>
                  <div className="text-sm text-emerald-100">Level 1 Certified</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
                  <div className="text-2xl font-bold mb-2">SOC 2</div>
                  <div className="text-sm text-emerald-100">Type II Compliant</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-lg">
                  <div className="text-2xl font-bold mb-2">ISO 27001</div>
                  <div className="text-sm text-emerald-100">Certified</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={index} className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-600 font-semibold">{study.results}</p>
                  </div>
                </div>
              </div>
            ))}
