      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-100 mb-4 sm:mb-6">
              Hardware & Software – All From One Partner
            </h1>
            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6 mt-8 sm:mt-12 text-xs sm:text-sm text-gray-200">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="order-2 lg:order-1">
                <p className="text-blue-500 font-semibold mb-3 sm:mb-4 uppercase tracking-wide text-sm sm:text-base">
                  Enterprise Solutions
                </p>
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 sm:mb-6 text-gray-200">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                  {enterpriseFeatures.map((feature, index) => (
                    <div key={index} className="flex items-start gap-3">
                      ...
                      <p className="text-sm sm:text-base text-gray-200">{feature}</p>
                    </div>
                  ))}
                </div>

                <a href="/contact">
                  <button className="bg-blue-600 text-primary-foreground px-6 py-3 sm:px-8 sm:py-3 rounded-lg font-semibold hover:bg-primary/90 transition-colors text-sm sm:text-base w-full sm:w-auto">
                    Contact Sales Team
                  </button>
                </a>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16">
              {categories.map((category, index) => (
                <div
                  key={index}
                  className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 sm:p-6 lg:p-8 text-center hover:shadow-lg transition-shadow duration-300"
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-primary/10 text-blue-400 rounded-lg mb-3 sm:mb-4">
                    {category.icon}
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3 text-gray-200">
                    {category.title}
                  </h3>
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-4 text-gray-200">
