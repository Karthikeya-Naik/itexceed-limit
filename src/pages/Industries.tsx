...
const IndustryCard = ({ icon: Icon, title, description, solutions, slug }) => {
  return (
    <Link to={`/industries/${slug}`}>
      <div className="bg-gray-800/50 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-700 hover:border-gray-600 hover:shadow-lg transition-all duration-300 cursor-pointer h-full">
        ...
        <h3 className="text-xl sm:text-2xl font-semibold mb-3 sm:mb-4 text-gray-100">{title}</h3>
        <p className="text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed text-gray-200">{description}</p>
        ...
        <div className="mt-4 sm:mt-6 text-blue-400 font-semibold flex items-center text-sm sm:text-base">
          Learn More →
        </div>
      </div>
    </Link>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-900">
      <main className="pt-16 sm:pt-20">
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/30">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-100 mb-4 sm:mb-6 px-2">
              Industries We Serve
            </h1>
            <p className="text-lg sm:text-xl text-gray-400 px-2 sm:px-0">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
              <div className="bg-gray-800/50 p-6 sm:p-8 rounded-lg border border-gray-700">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-gray-200">Regulatory Compliance</h3>
              ...
              <div className="bg-gray-800/50 p-6 sm:p-8 rounded-lg border border-gray-700">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-gray-200">Proven Track Record</h3>
                <p className="text-gray-400 text-sm sm:text-base">
              ...
              <div className="bg-gray-800/50 p-6 sm:p-8 rounded-lg border border-gray-700">
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-gray-200">Scalable Solutions</h3>
                <p className="text-gray-400 text-sm sm:text-base">
