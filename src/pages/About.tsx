      ...
      <main className="pt-16 sm:pt-20">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-5xl mx-auto text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-200 mb-4 sm:mb-6 leading-tight">
              Magic happens when the best performing{" "}
              <span className="text-blue-400">IT solutions</span> meet the{" "}
              <span className="text-blue-400">brightest talent.</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 mt-6 sm:mt-8 px-4">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-gray-300 max-w-4xl mx-auto px-4">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center mb-16 sm:mb-20">
              <div className="order-2 lg:order-1">
                <h3 className="text-2xl sm:text-3xl font-bold text-gray-200 mb-4 sm:mb-6">Our Story</h3>
              ...
              <div className="relative order-1 lg:order-2">
                <div className="bg-gradient-to-br from-primary/20 to-accent rounded-xl sm:rounded-2xl p-6 sm:p-8 h-64 sm:h-80 lg:h-96 flex items-center justify-center">
                  <div className="text-center space-y-4 sm:space-y-6">
                    <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-blue-900">9+</div>
                    <p className="text-lg sm:text-xl font-medium">Years of Excellence</p>
                    <p className="text-xs sm:text-sm text-muted">Since 2016</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              {/* Managed Services */}
              <div className="bg-gray-800/60 rounded-xl sm:rounded-2xl overflow-hidden border border-gray-600 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-200">Managed Services</h3>
              ...
              <div className="bg-gray-800/60 rounded-xl sm:rounded-2xl overflow-hidden border border-gray-600 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-200">Network Infrastructure</h3>
                  <p className="text-sm sm:text-base text-gray-400">
              ...
              <div className="bg-gray-800/60 rounded-xl sm:rounded-2xl overflow-hidden border border-gray-600 shadow-sm hover:shadow-lg transition-shadow">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-3 text-gray-200">Cloud Solutions</h3>
                  <p className="text-sm sm:text-base text-gray-400">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
              <div className="bg-gray-800/50 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-600">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-100">Customer Focus</h3>
              ...
              <div className="bg-gray-800/50 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-600">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-100">Excellence</h3>
                <p className="text-sm sm:text-base text-gray-300">
              ...
              <div className="bg-gray-800/50 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-600">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-100">Collaboration</h3>
                <p className="text-sm sm:text-base text-gray-300">
              ...
              <div className="bg-gray-800/50 p-4 sm:p-6 lg:p-8 rounded-lg border border-gray-600">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-gray-100">Innovation</h3>
                <p className="text-sm sm:text-base text-gray-300">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
              <div className="bg-gray-800/50 p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl border border-gray-600">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-100 mb-4 sm:mb-6">Our Mission</h2>
              ...
              <div className="bg-gray-800/50 p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl border border-gray-600">
                <h2 className="text-2xl sm:text-3xl font-bold text-gray-100 mb-4 sm:mb-6">Our Vision</h2>
                <p className="text-base sm:text-lg text-gray-400 leading-relaxed">
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900 to-gray-800/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-8 sm:mb-12 mx-28">
              <div className="text-center bg-gray-800/60 p-4 sm:p-6 rounded-lg border border-gray-600">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-400 mb-2">9+</div>
                <p className="text-xs sm:text-sm text-gray-300">Years in Business</p>
              </div>
              <div className="text-center bg-gray-800/60 p-4 sm:p-6 rounded-lg border border-gray-600">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-400 mb-2">98%</div>
                <p className="text-xs sm:text-sm text-gray-300">Customer Satisfaction</p>
              </div>
              <div className="text-center bg-gray-800/60 p-4 sm:p-6 rounded-lg border border-gray-600">
                <div className="text-3xl sm:text-4xl lg:text-5xl font-bold text-blue-400 mb-2">24/7</div>
                <p className="text-xs sm:text-sm text-gray-300">Support Available</p>
              </div>
            </div>
          </div>
        </section>
