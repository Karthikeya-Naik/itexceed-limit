...
//     window.location.href = 'tel: +44 7908 848685';
//   };
...
const Contact = () => {
  ...
  const WHATSAPP_NUMBER = "447908848685";
  ...
  const handleWhatsAppSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `*New Contact Form Submission - ITExceed*%0A%0A*Name:* ${formData.name}%0A*Email:* ${formData.email}%0A*Company:* ${formData.company || "Not provided"}%0A*Phone:* ${formData.phone || "Not provided"}%0A*Message:* ${formData.message}%0A%0A*Submitted from:* ITExceed Website`;
  ...
  const handleEmergencyCall = () => {
    window.location.href = 'tel:+447908848685';
  };
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="lg:col-span-1 space-y-4 sm:space-y-6">
                <Card>
                  ...
                  <CardContent className="space-y-3 sm:space-y-4">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-xs sm:text-sm text-gray-100">Phone</p>
                        <p className="text-xs sm:text-sm text-gray-400">+44 7908 848685</p>
                        {/* <p className="text-xs sm:text-sm text-gray-400">+44 20 8765 4321</p> */}
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="font-semibold text-xs sm:text-sm text-gray-100">Email</p>
                        <p className="text-xs sm:text-sm text-gray-400">r.chhabra@itexceed.com</p>
                        <p className="text-xs sm:text-sm text-gray-400">info@itexceed.com</p>
                      </div>
                    </div>
                ...
                <Card className="bg-gradient-to-b from-green-900/30 to-green-800/20 border-green-700/50">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-lg sm:text-xl text-green-400">Chat on WhatsApp</CardTitle>
                  ...
                  <CardContent>
                    <Button 
                      onClick={() => window.open(`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20ITExceed%2C%20I%20need%20IT%20support%20for%20my%20business.`, '_blank')}
              ...
              <div className="lg:col-span-2">
                <Card>
                  <CardHeader className="pb-4">
                    <CardTitle className="text-lg sm:text-xl">Send Us a Message</CardTitle>
                    <CardDescription className="text-xs sm:text-sm">
                      Fill out the form below and click send - it will open WhatsApp with your details
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
